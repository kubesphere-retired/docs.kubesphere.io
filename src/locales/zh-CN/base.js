module.exports = {
  ...
  'Quick search': '快速查找',
  Documentation: '文档中心',
  'Recommend you to download and use the latest free':
    '推荐您免费下载和使用最新的',
  'KubeSphere uses': 'KubeSphere 使用',
  'to manage bug tracking': '来管理 bug 跟踪',
  'Report the Bug': '报告 Bug',
  Communication: '日常沟通',
  'Find us on the Slack channel': '在 Slack 频道上找到我们',
  'KubeSphere Advanced Edition': 'KubeSphere 高级版',
  Found: '共找到',
  'related message(s)': '条相关信息'
}
