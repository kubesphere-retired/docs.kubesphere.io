...
### 组件升级
 ...
 - 集成 [QingStor NeonSAN 存储插件](https://github.com/yunify/qingstor-csi)，可提供高可用、高性能 SAN 存储服务  
...
### 日志  
 ...
 - 支持日志详情页直达容器组或者容器详情页  
 - 基于自研 [FluentBit Operator](https://github.com/kubesphere/fluentbit-operator) 提供灵活的日志收集配置：可添加 Elasticsearch、Kafka 和 Fluentd 作为日志接收者，并可按需激活/关闭；在发送给日志接收者前，可灵活输入过滤条件筛选出感兴趣的日志  
