...
S2i 使用源代码和构建器镜像生成新的 Docker 镜像，在我们的项目当中提供了部分常用的构建器镜像，例如[Python](https://github.com/kubesphere/s2i-python-container/)、[Java](https://github.com/kubesphere/s2i-java-container/)，您也可以定义自己的构建器镜像 (即 S2i 模板) 扩展 S2i。
...
[S2i 命令行工具](https://github.com/openshift/source-to-image/releases) 带有一个方便的命令，可以引导构建器所需的目录结构，我们将使用以下命令生成我们的目录结构：
