...
4.2.3. In the centent area, click **Add nesting steps** in the `maven` container created above to add a nested step. Then select **shell** and enter the following command in the pop-up window:
...
### Step 8: Download Articraft

Enter the first activity and select **Articrafts**. You can find the articraft of jar package generated by the pipeline, and you can download it by clicking the icon.
